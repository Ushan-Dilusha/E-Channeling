    ...
    <a class="navbar-brand" href="index.jsp"><img src="image/main.png" height="34"></a>
	  ...
	  <div class="collapse navbar-collapse" id="navbarNav">
		    ...
		    <ul class="navbar-nav">
			      ...
			      <li class="nav-item">
				    	<a class="nav-link text-white"  href="editorHome.jsp">Home</a>
				  	</li>
			      
			    	
			 	 	<li class="nav-item" >
			        	<a class="nav-link text-white" href="stafflogin.jsp.jsp">Log Out</a>
			      	</li>
	   ...
	   <div class="collapse navbar-collapse" id="navbarNav">
		    ...
		    <ul class="navbar-nav">
			      ...
			      <li class="nav-item">
			 	 	...
			 	 	<li class="nav-item" >
			        	<a class="nav-link text-white" href="stafflogin.jsp">Log Out</a>
			      	</li>
